...
class Department(models.Model):
    ...
    status=models.CharField(max_length=40,null=True,blank=True,default='Pending',choices=STATUS)
    def __str__(self):
       return self.name
...
class Student(models.Model):
    ...
    status=models.CharField(max_length=40,null=True,default='Pending',choices=STATUS)
    CGPA = models.FloatField(null=True,blank=True,validators=[MinValueValidator(0.0), MaxValueValidator(4.0)])
    result_description=models.CharField(default="Not Details Available now.",max_length=3000,null=True,blank=True)
    def __str__(self):
       return self.name
...
class AdminNotice(models.Model):
    ...
    receiver=models.CharField(max_length=20, null=True, choices=RECEIVER)
    reveiver_dept=models.ForeignKey(Department,null=True,on_delete=models.SET_NULL,blank=True)
